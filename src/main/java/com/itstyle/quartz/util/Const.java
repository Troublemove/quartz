...
public class Const {
	...
	//public static final String FILEPATH2 = "C:/work2";			//文件上传路径
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(weixin)|(static)|(main)|(websocket)|(uploadImgs)|(fhfile)|(api)|(equipment)).*";	//不对匹配该值的访问路径拦截（正则）
